...
`
  ...
  var socketPath = document.querySelector("meta[name='socket-path']").getAttribute("content");
  var socketTransport = document.querySelector("meta[name='socket-transport']").getAttribute("content");
  var normalizedTransport = socketTransport == "longpoll" ? LongPoll : WebSocket;
